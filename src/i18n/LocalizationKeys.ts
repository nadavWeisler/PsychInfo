export class LocalizationKeys {
        ...
        Share: 'common.share',
        Hello: 'common.hello',
        Personalize: 'common.personalize',
        InvalidLink: 'common.invalid_link',
        Login: 'common.login',
        ...
        NotRequired: 'common.not_required',
        }
        static Errors = {
        ErrorOccured: 'errors.error_occured',
        InvalidDataType: 'errors.invalid_data_type',
        }
        static Welcome = {
        Title: 'welcome.title',
        ...
        static Wizard = {
        WhichInfoYouNeed: 'wizard.which_info_you_need',
        ChooseOrganizations: 'wizard.choose_organizations',
        ChooseTags: 'wizard.choose_tags',
        ChooseAll: 'wizard.choose_all',
        Clear: 'wizard.clear',
        ChooseLanguages: 'wizard.choose_languages',
        InvalidStep: 'wizard.invalid_step',
        NoTags: 'wizard.no_tags',
        NoOrgs: 'wizard.no_orgs',
        NoLangs: 'wizard.no_langs',
        }
        static Upload = {
        Title: 'upload.title',
        ...
        Login: 'admin.login',
        OpenTags: 'admin.open_tags',
        OpenOrganizations: 'admin.open_organizations',
        ...
        Ana: {
        Title: 'credits.ana.title',
        Description: 'credits.ana.description',
        },
        }
        static Register = {
        ...
        static SignIn = {
        InvalidEmail: 'sign_in.invalid_email',
        InvalidCred: 'sign_in.invalid_cred',
        GeneralError: 'sign_in.general_error',
        }
