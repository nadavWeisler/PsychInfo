...
describe("test texts of accordion NOT in request mode", () => {
  it("renders", () => {
    ...
    const indexes = ["0", "1", "2"];
    cy.get('[data-testid="description-title"]').should("have.text", "תיאור");
    cy.get('[data-testid="description"]').should("have.text", data.description);
